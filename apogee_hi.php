<?php
  ...
  if (!isset($_SESSION['user'])) {
    ...
    $query  = "SELECT * FROM main_table m, id_table i, orbit_table o WHERE m.NORAD_Number = i.NORAD_Number AND i.Orbit_ID = o.Orbit_ID AND o.Apogee_km > 35000 ORDER BY o.Apogee_km;";
