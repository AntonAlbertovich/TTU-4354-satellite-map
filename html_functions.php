...
<h5 class="card-title">Country 1</h5>
  <select class="form-control" select id="country_1" name="country_1" >
		...
		<id="Card" class="Choose one coutry">Select Operator</small>
  		<id="Card" class="Choose one coutry">Example:NASA, Norwegian Coastal Admnistration, US Air Force </small>
	        
  	    	<div class="input-group">
        	<input type="text" class="form-control" placeholder="Search for..." name="oper1">
      		</div>
  </div>
  <div class="card text-white bg-danger mb-3">
  <h5 class="card-title">Country 2</h5>
  <select class="form-control" select id="country_2" name="country_2" >
  		<option selected="selected" value=""></opt
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
                <option value="Albania">Albania</option>
		...
		<id="Card" class="Choose one coutry">Select Operator</small>
  		<id="Card" class="Choose one coutry">Example:Gazprom Space Systems, Chinese Academy of Sciences,  Ministry of Defense</small>
		<form method="get">
      	<div class="input-group">
